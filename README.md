...
6. Install the ruby bundles with the following series of commands:
...
9. Load the dump in the postgreSQL database. This process may vary for different operating systems. For Linux, use:
...
11. To start the local server with Rails, run:
