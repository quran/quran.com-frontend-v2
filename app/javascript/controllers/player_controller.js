...
export default class extends Controller {
    ...
    playWord(audioPath) {
        ...
        return new Howl({
            ...
            onplayerror: () => {
                wasPlaying && this.handlePlayBtnClick();
            },
            onend: () => {
                wasPlaying && this.handlePlayBtnClick();
            }
    ...
    repeatSingleVerse() {
        ...
        if (
            this.config.repeat.count == "loop" ||
            this.config.repeat.iteration < this.config.repeat.count
        ) {
            //  play the same verse
    ...
    repeatRangeVerses() {
        ...
        if (this.track.currentVerse == repeatSetting.to) {
            ...
            if (
                repeatSetting.count == "loop" ||
                repeatSetting.iteration < repeatSetting.count
            ) {
                console.log(
                    "repeating range, ",
